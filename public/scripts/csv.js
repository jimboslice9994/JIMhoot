...
function canonicalHeader(value) {
  ...
  const aliases = {
    ...
    option_c: 'choice_c',
    option_d: 'choice_d',
    answer_choice: 'correct_choice',
    correct_answer: 'correct_choice',
    correctanswer: 'correct_choice',
    correct_option: 'correct_choice',
    explanation: 'answer_explanation',
    flashcard_question: 'flashcard_front',
    flashcard_answer: 'flashcard_back',
    sentence: 'fill_blank_sentence',
    fill_blank: 'fill_blank_sentence',
    fill_blank_correct_answer: 'fill_blank_answer',
  };
...
export function parseAndImportCsv(csvText) {
  ...
  const header = rows[0].map((h) => canonicalHeader(h));
